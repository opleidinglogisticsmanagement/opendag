      ...
      <div className="bg-white shadow-md flex-shrink-0">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center justify-center gap-2 mb-1">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-logistics-orange">
              Warehouse Wizard
            </h1>
          </div>
      ...
      <div className="bg-white border-b border-gray-200 flex-shrink-0">
        <div className="container mx-auto px-4 py-2">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
            <div className="bg-blue-500 rounded-lg p-2 text-center text-white">
            ...
            <div className="bg-green-500 rounded-lg p-2 text-center text-white">
              <div className="text-xs mb-1 flex items-center justify-center gap-1">
                <span>📊</span>
                <span>Score</span>
              </div>
            ...
            <div className="bg-yellow-500 rounded-lg p-2 text-center text-white">
              <div className="text-xs mb-1 flex items-center justify-center gap-1">
                <span>✅</span>
                <span>Orders</span>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 h-full">
          ...
          <div className="lg:col-span-1">
            <Card className="bg-gray-50 p-4">
              <h3 className="text-base font-bold text-gray-800 mb-3">Hoe te spelen:</h3>
                  ...
                  row.map((location, colIdx) => {
                    ...
                    return (
                      <button
                        ...
                        className={`aspect-square rounded-lg font-bold text-base md:text-lg transition-all duration-200 ${
                          cellClass
      ...
      <div className="bg-white border-t border-gray-200 flex-shrink-0">
        <div className="container mx-auto px-4 py-2 text-center">
          <Button
            ...
            } text-white text-base px-8 py-2`}
          >
